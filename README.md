...
Render erlaubt nur eine kostenlose Datenbank pro Account. Alternativen waren Supabase und PlanetScale. Supabase bietet mehr Features, war aber für eine einfache REST API überdimensioniert. Neon ist spezialisiert auf PostgreSQL, hat ein grosszügiges Free Tier, automatisches SSL und einfache Integration — die schlankste Lösung.
...
Ein Single-Stage Dockerfile hätte ein grösseres Image erzeugt. Multi-Stage trennt Build- und Runtime-Umgebung: Das finale Image enthält nur Production-Dependencies. Der Non-Root-User ist eine Security Best Practice.

**Warum Swagger UI?**
Alternativen waren Postman oder manuelle Dokumentation. Swagger UI generiert automatisch interaktive Dokumentation direkt aus dem Code — immer aktuell, im Browser nutzbar.
